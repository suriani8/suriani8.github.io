...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  document.getElementById('refaddress').value = 'http://149.28.129.186/?ref=' + document.getElementById('refaddress').value;
}
}
}
function calculate() {
...
function openportal(){
        if (balance < 1000){
          Swal.fire({
            ...
            if (result.value) {
              window.location.href = 'http://149.28.129.186/index.html#airdrop';
            }
          }); 
        }
        else{
                          ...
                          web3.currentProvider.sendAsync({
                            ...
                            params: {
                                ...
                                'options': {
                                    ...
                                    'symbol': 'ZOYA',
                                    'decimals': '18',
                                    'image': src='http://149.28.129.186/img/logo/logo-m.png',
                                },
                            },
